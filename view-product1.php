            ...
            <div class="flex flex-row row-50 product-info-container">
                ...
                <div class="row-right">
                    ...
                    <div class="product-actions-container">
                        <form action="view-product.php" method="post" id="addTocart_form">
                            <input type="number" class="addTocart_quantity" name="quantity" id="quantity" min="1" max="<?php echo $product_quantity ?>" value="1">
                            <input type="hidden" name="product_id" value="<?php echo $product_id ?>">
                            <button type="submit" class="btn btn-primary addTocart-btn">Add To Cart</button>
                        </form>
                    </div>
                </div>
            </div>
